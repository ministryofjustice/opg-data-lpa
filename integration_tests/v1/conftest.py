...
opg_data_lpa_dev_aws = {
    ...
    "online_tool_endpoint": {
        "url": "https://in319.dev.lpa.api.opg.service.justice.gov.uk/v1/lpa-online-tool/lpas",
        "method": "GET",
        "valid_lpa_online_tool_ids": ["A33718377316"],
        "invalid_lpa_online_tool_ids": ["banana"],
    },
    "use_an_lpa_endpoint": {
        "url": "https://in319.dev.lpa.api.opg.service.justice.gov.uk/v1/use-an-lpa/lpas",
        "method": "GET",
        "valid_sirius_uids": ["700000000013"],
        "invalid_sirius_uids": ["9"],
    },
